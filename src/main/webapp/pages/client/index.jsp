...
<html>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("button.addToCart").click(function () {
                    ...
                    // alert(url);
                    // var tureURL = "http://" + url + ":8080/FuckBook/cartServlet?action=addItem&id=" + bookId;
                    // // alert(tureURL);
                    // location.href = tureURL;
                    $.getJSON("${basePath}cartServlet","action=ajaxAddItem&id=" +
    ...
    <body>
        ...
        <div id="header">
            ...
            <div>
                <%--如果用户还没有登录，就显示登录和注册的信息--%>
                <c:if test="${empty sessionScope.user}">
                    <a href="pages/user/login.jsp">登录</a> |
                    <a href="pages/user/regist.jsp">注册</a> &nbsp;&nbsp;
                </c:if>
                <%--如果用户已经登录，就显示登录成功之后的信息--%>
            ...
            <div id="book">
                ...
                <c:if test="${empty sessionScope.cart.items}">
                    ...
                    <div style="text-align: center" id="cartTotalCount">
                        <div>
                            <span style="color: red"  class="cartLastName">购物车空了o(TヘTo)</span>
                        </div>
                    </div>
                </c:if>
